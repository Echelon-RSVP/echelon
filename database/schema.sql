...
CREATE TABLE IF NOT EXISTS user_settings (
  ...
  lens TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS conversations (
  ...
  read_ts_a BIGINT NOT NULL DEFAULT 0,
  read_ts_b BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS messages (
  ...
  reply_text VARCHAR(280) NULL,
  burn_mode VARCHAR(16) NULL,
  burn_seconds INT NULL,
